...
class PspdfkitInstantJsonExampleWidget extends StatefulWidget {
  ...
  @override
  _PspdfkitInstantJsonExampleWidgetState createState() => _PspdfkitInstantJsonExampleWidgetState();
}

class _PspdfkitInstantJsonExampleWidgetState extends State<PspdfkitInstantJsonExampleWidget> {
                  ...
                  child: Row(children: <Widget>[
                    ...
                    MaterialButton(
                        onPressed: () async {
                          ...
                          await view.exportInstantJson().then((exportedInstantJson) async {
                            await showDialog<AlertDialog>(
                                context: context,
                                builder: (BuildContext context) => AlertDialog(
                                      title: const Text(title),
                                      content: Text(exportedInstantJson ?? 'No Instant JSON found.'),
                                      actions: [
                                        TextButton(
                                            onPressed: () {
